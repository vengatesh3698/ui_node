import { _ as _sfc_main } from "./VaAvatarGroup.vue_vue_type_script_lang-f3bc238b.mjs";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    renderSlot(_ctx.$slots, "rest", normalizeProps(guardReactiveProps(_ctx.avatarProps)), () => [
      createVNode(_component_va_avatar, mergeProps(_ctx.avatarProps, { role: "listitem" }), {
        default: withCtx(() => [
...
//# sourceMappingURL=VaAvatarGroup-6a928ae5.mjs.map
